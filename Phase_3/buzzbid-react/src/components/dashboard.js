    ...
    return (
        <div className="outer-container">
            ...
            <div className="d-flex justify-content-center align-items-center">
                <div className="bg d-flex bg-body-tertiary mb-3 text-center">
                            ...
                            <MDBCol md="12">
                                <p className="mb-4 text-center">
                                    ...
                                    {currentUser.userRole &&
                                        <span>Administrative position: {currentUser.userRole}</span>}
                                </p>
                            </MDBCol>
                        </MDBRow>
                        <MDBRow>
                            ...
                            <MDBCol md="6">
                                <div className="text-center">
                                    <MDBBtn type="button" className="mb-4 d-block btn-primary"
                                            style={{height: '50px', width: '100%'}} onClick={handleLogout}>Log
                                        Out</MDBBtn>
                                </div>
                            </MDBCol>
                        </MDBRow>
