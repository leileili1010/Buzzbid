                    ...
                    <form onSubmit={submitForm}>
                        <MDBContainer className="p-3">
                            <MDBRow>
                                ...
                                <MDBCol md="8">
                                    <MDBInput wrapperClass='mb-4' placeholder='Item Name' id='item-name' name="itemName"
                                              value={inputs.itemName} type='text'
                                              onChange={updateValue}
                                              style={{border: errors.itemName ? "2px solid red" : null}}/>
                            ...
                            <MDBRow>
                                ...
                                <MDBCol md="8">
                                    <MDBTextArea wrapperClass='mb-4' placeholder='Description' id='description'
                            ...
                            <MDBRow>
                                ...
                                <MDBCol md="8">
                                    <MDBInput wrapperClass='mb-4' placeholder='$0.00' id="starting-bid"
                                              name="startingBid"
                            ...
                            <MDBRow>
                                ...
                                <MDBCol md="8">
                                    <MDBInput wrapperClass='mb-4' placeholder='$0.00' id='min-sale-price'
                                              name="minSalePrice" value={inputs.minSalePrice}
                                              type='text'
                                              onChange={updateValue}
                            ...
                            <MDBRow>
                                ...
                                <MDBCol md="8">
                                    <MDBInput wrapperClass='mb-4' placeholder='$0.00' id="get-it-now-price"
                                              name="getItNowPrice" value={inputs.getItNowPrice}
                                              type='text'
                                              onChange={updateValue}
                            ...
                            <MDBRow>
                                ...
                                <MDBCol md="8">
                                    <select className="form-select" id="is-returnable" name="isReturnable"
                                            value={inputs.isReturnable}
                                            onChange={updateValue}>
